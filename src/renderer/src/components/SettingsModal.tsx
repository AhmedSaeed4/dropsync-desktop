...
interface SettingsModalProps {
  ...
  onVaultMoved?: () => void;
  /** C2 §2: mid-session "Switch to Cloud" — same guarded path as the badge menu. */
 ...
 */
export function SettingsModal({ onClose, onLockNow, onVaultMoved, onSwitchToCloud }: SettingsModalProps) {
